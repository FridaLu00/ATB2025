    ...
    <div className="pb-40">
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-black/70">
              蔡文轩、董家琪、童诗雨、徐铭蔚、谭景文、杨新潮、童扬、周逸伦
            </p>
          </div>
          ...
          <div>
            ...
            <div className="text-lg md:text-xl leading-relaxed text-black/70">
              <p style={{ textIndent: "2em", marginBottom: "1.5em" }}>
                《汴河序》是一项以《清明上河图》为原型的沉浸式互动展览。展览通过精心设计的六大核心互动点，带领观众穿越时空，走进北宋历史，成为画中人。
              </p>
              <p style={{ textIndent: "2em" }}>
                展览完美融合了深厚的历史科普与强烈的叙事代入感。观众不仅能深度体验宋代高超的造船工艺与内河航运智慧，更能切身感受汴河作为汴京生命线所串联起的鲜花铺、外卖文化等繁华市井生态。这是一场科技与传统美学交织的盛宴，生动再现了北宋时期的城市脉搏与大宋烟火气。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="pt-8 md:pt-8 pb-12 md:pb-20 bg-gray-50">
        <div className="mx-auto max-w-6xl px-6 md:px-10">
          ...
          {/* Gallery Container - 固定两列布局，适应两张图片 */}
      ...
      <section className="pt-8 md:pt-8 pb-12 md:pb-20 bg-gray-50">
        <div className="mx-auto max-w-4xl px-6 md:px-10">
          ...
          {/* 视频播放器 - 使用浏览器默认控件，支持多种格式 */}
          <div className="aspect-video rounded-xl overflow-hidden shadow-lg bg-black">
            <video
              className="w-full h-full object-contain"
              controls
              preload="metadata"
              poster="/2bianhexu/banner.png"
            >
              <source src="https://pub-6dcb6ed488d54018b91f8924fb08b74f.r2.dev/video/2.mp4" type="video/mp4" />
              <source src="/2bianhexu/SP.MOV" type="video/quicktime" />
              <source src="/2bianhexu/SP.webm" type="video/webm" />
              <source src="/2bianhexu/SP.ogv" type="video/ogg" />
