...
export default function Project6Content({ project }: ProjectContentProps) {
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-black/70">
              陳莲茹、来怡楠、陆李媛、文艺欣、杨婧怡、翟佳琪、李家衡、庄凯玲
            </p>
          </div>
          ...
          <div>
            ...
            <div className="text-lg md:text-xl leading-relaxed text-black/70">
              <p style={{ textIndent: "2em", marginBottom: "1.5em" }}>
                本设计以“唐朝女子服饰与妆容的审美变迁”为核心主题，依托VR虚拟技术构建沉浸式展览空间，通过“时间演变—空间叙事—互动体验”的方式，将初唐至晚唐女性形象的变化转化为可游览、可感知的视觉与空间体验。
              </p>
              <p style={{ textIndent: "2em", marginBottom: "1.5em" }}>
                整体空间以曲线流动为组织逻辑，结合卷轴、屏风、灯箱等具有东方意象的展示形式，营造富有唐代审美气质的文化氛围；同时通过服饰结构解析、场景复原与互动体验等多层次内容，使观者在参与中理解唐代社会审美、文化观念及女性形象的演变。
              </p>
              <p style={{ textIndent: "2em" }}>
                设计旨在突破传统静态展陈方式，以数字化手段实现传统文化的创新表达与传播。
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6 md:px-10">
          ...
          <div className="aspect-video rounded-xl overflow-hidden shadow-lg bg-black">
            <video
              ...
              preload="metadata"
            >
              <source src="https://pub-6dcb6ed488d54018b91f8924fb08b74f.r2.dev/video/6.mp4" type="video/mp4" />
              <source src="/6tanggong/SP.webm" type="video/webm" />
              <source src="/6tanggong/SP.ogv" type="video/ogg" />
