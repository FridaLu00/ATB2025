...
export default function Project17Content({ project }: ProjectContentProps) {
  const [showViewer, setShowViewer] = useState(false);
  const [selectedImageIndex, setSelectedImageIndex] = useState(0);

  const displayImages = ["/17xianshuiyao/ZB.png"];
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <div
            ...
            style={{
              ...
              backgroundImage: `url(/17xianshuiyao/banner.png)`,
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-black/70">
              陈钧天、陈睿旖、金书尧、马婵、孙鑫怡、汤琬儿、王若溪、曾诗婕、何蕊
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg md:text-xl leading-relaxed text-black/70" style={{ textIndent: "2em" }}>
              本项目旨在打造一个以疍家文化为核心的主题海上餐厅。我们将通过海上场景设计，整体品牌包装(VI)及点餐App的全方位设计，将疍家独特的水上生活与饮食文化转化为现代沉浸式消费体验，使其成为一个传递"海韵渔情"的文化地标与特色商业空间。
            </p>
          </div>
        </div>
      </section>
